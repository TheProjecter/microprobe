...
*/
	...
	define('QA_MYSQL_HOSTNAME', 'mysql.cs.pitt.edu'); // try '127.0.0.1' or 'localhost' if MySQL on same server
	define('QA_MYSQL_USERNAME', 'ezegarra');
	define('QA_MYSQL_PASSWORD', 'peru1995');
	define('QA_MYSQL_DATABASE', 'ezegarraDB');
...
*/
	...
	define('QA_MYSQL_TABLE_PREFIX', 'qa4_');
