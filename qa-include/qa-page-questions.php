...
//	Get list of questions, plus category information
	...
	switch ($sort) {
		...
		case 'answers':
			$questionselect=qa_db_qs_selectspec($qa_login_userid, 'acount', $qa_start, mp_get_categoryslug());
			break;
			
		case 'views':
			$questionselect=qa_db_qs_selectspec($qa_login_userid, 'views', $qa_start, mp_get_categoryslug());
			break;
		
		default:
			//$questionselect=qa_db_qs_selectspec($qa_login_userid, 'created', $qa_start, $categoryslugs);
			$questionselect=qa_db_qs_selectspec($qa_login_userid, 'created', $qa_start, mp_get_categoryslug());
			break;
	}
