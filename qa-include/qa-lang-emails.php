...
*/
	...
	return array(
		...
		'q_answered_with_category_subject' => 'An answer has been posted on ^category_title',
		'q_answered_with_category_body' => "An answer to question ^q_title has been posted by ^a_handle.\n\n^a_content\n\nClick below to see the question and answer:\n\n^url\n\nThank you,\n\n^site_title",
		...
		'q_posted_with_category_subject' => '^site_title has a new question posted to ^category_title',
		...
		'an_posted_subject' => 'An announcement has been posted for ^category_title in ^site_title',
		'an_posted_body' => "A new announcment by ^an_handle has been posted for ^category_title with title ^an_title.  To view the entire details visit the announcements page:\n\n ^an_url\n\nThank you,\n\n^site_title",
	);
