...
*/
	{
		$eventParams = array('path'=>qa_path($request, $params, $rooturl, $neaturls, $anchor));
		qa_report_event('page_redirect', qa_get_logged_in_userid(), qa_get_logged_in_handle(), qa_cookie_get(), $eventParams);
